...
enum Theme {
    ...
    /// Shortcuts Herd's menus own; unbound in the renderer so the surface lets them through.
    static let herdShortcutUnbinds = [
        ...
        "super+digit_8",
        "super+digit_9",
        // Font size is Herd's View menu, which changes the setting for every
...
/// System display preferences Herd follows (System Settings > Accessibility
