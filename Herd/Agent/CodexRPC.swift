...
/// `AgentSession`); this is for the things Herd asks outside one: what the
...
enum CodexRPC {
    ...
    /// What `initialize` says about Herd. `experimentalApi` is what lets a
    ...
    static func handshake(requestId: Int = 1) -> [[String: Any]] {
        [
            ["jsonrpc": "2.0", "id": requestId, "method": "initialize",
             "params": ["clientInfo": ["name": "herd", "title": "Herd", "version": AgentSession.version],
