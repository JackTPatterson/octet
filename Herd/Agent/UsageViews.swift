...
struct AccountCard: View {
    ...
    private var pending: String {
        ...
        return SettingsStore.shared.values.readClaudeAccountUsage
            ? "No allowance to show yet. Herd asks your Claude account, falls back to the usage Claude Code last cached, and takes live numbers from any conversation you run."
            : "No allowance to show yet. Herd reads the usage Claude Code last cached and live numbers from conversations you run here. For live numbers any time, turn on \u{201C}Read live usage from your Claude account\u{201D} in Settings."
    }
