...
final class AgentStreamTests: XCTestCase {
    ...
    func testPermissionMCPServesTheApproveTool() throws {
        ...
        XCTAssertTrue(initialize?.contains("\"herd\"") == true)
        ...
        XCTAssertEqual(PermissionMCP.qualifiedToolName, "mcp__herd__approve")
    }
    ...
    func testAllowEchoesTheInputUnchanged() throws {
        ...
        XCTAssertEqual(deny["message"] as? String, "The user declined this in Herd.")
    }

    func testSocketRoundTrip() throws {
        let path = NSTemporaryDirectory() + "herd-perm-test-\(UUID().uuidString.prefix(6)).sock"
...
final class CodexApprovalTests: XCTestCase {
    ...
    func testEveryRequestKindIsCovered() {
        ...
        // What Herd can't show yet still gets words for the transcript.
